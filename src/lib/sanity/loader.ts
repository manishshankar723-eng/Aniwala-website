...
export const sanityBrand = (): Loader =>
  sanityLoader({
    ...
    projection: `
      ...
      typeBodyScale, typeBodyWeight, typeBodyTrack,
      typeLabelScale, typeLabelWeight, typeLabelTrack,
      typeMonoScale, typeMonoWeight, typeMonoTrack,
    ...
    toData: (doc, isDraft) => ({
      ...
      /* Typography. Every one of these has a default that reproduces the
         ...
         100 is "the size it was drawn at", 0 is "leave it alone". */
      fontDisplay: doc.fontDisplay ?? '',
      fontBody: doc.fontBody ?? '',
      fontLabel: doc.fontLabel ?? '',
      fontMono: doc.fontMono ?? '',
      textScale: doc.textScale ?? 100,
      typeDisplayScale: doc.typeDisplayScale ?? 100,
      typeDisplayWeight: doc.typeDisplayWeight ?? 0,
      typeDisplayTrack: doc.typeDisplayTrack ?? 0,
      typeHeadingScale: doc.typeHeadingScale ?? 100,
      typeHeadingWeight: doc.typeHeadingWeight ?? 0,
      typeHeadingTrack: doc.typeHeadingTrack ?? 0,
      typeBodyScale: doc.typeBodyScale ?? 100,
      typeBodyWeight: doc.typeBodyWeight ?? 0,
      typeBodyTrack: doc.typeBodyTrack ?? 0,
      typeLabelScale: doc.typeLabelScale ?? 100,
      typeLabelWeight: doc.typeLabelWeight ?? 0,
      typeLabelTrack: doc.typeLabelTrack ?? 0,
      typeMonoScale: doc.typeMonoScale ?? 100,
      typeMonoWeight: doc.typeMonoWeight ?? 0,
      typeMonoTrack: doc.typeMonoTrack ?? 0,
